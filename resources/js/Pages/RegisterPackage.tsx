...
export default function RegisterPackage({users}: Props) {
            ...
            <div className="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8">
                <form action="" onSubmit={handleSubmit} >
                    <div className="flex flex-col mb-4">
                        ...
                        <InputError message={errors.nombrePaquete} className="mt-2" />
                    </div>
                    ...
                    <InputError message={errors.descripcionPaquete} className="mt-2" />
                    <div className="flex flex-col mt-4 gap-y-4">
                        ...
                        <div className="flex justify-start items-center gap-x-2">
                            ...
                            <InputError message={errors.usuarioDestinatario} className="mt-2" />
                        </div>
                    </div>
                    <div className="mt-4">
                        ...
                        <InputError message={errors.usuarioRecibio} className="mt-2" />
                        <div className="mt-4 flex items-center gap-x-4">
                            ...
                            <InputError message={errors.horaLlegadaPaquete} className="mt-2" />
                        </div>
                    </div>
